...
def main():
    ...
    model_path = './weights/4x_cc-system-product-name_epoch_70.pth'
    # model = Sakuya_arch.LunaTokis(64, N_ot, 8, 5, 40)

    model = STVSR(nf=64, nframes=3, groups=8, front_RBs=5, back_RBs=20)

    # model = STVSR(nf=64, nframes=7, groups=8, front_RBs=5, back_RBs=40)
    ...
    if data_mode == 'Vid4':
        test_dataset_folder = '/home/chl/PycharmProjects/dataset/189_vime7/test/test/000/input'
    if data_mode == 'SPMC':
        test_dataset_folder = '/home/chl/PycharmProjects/dataset/Jilin-189/testset/eval/eval/LR4x/*'
    if data_mode == 'Custom':
        # test_dataset_folder = '../test_example/*' # TODO: put your own data path here
        test_dataset_folder = '/home/chl/PycharmProjects/dataset/189_vime7/test/LR/*'
        # test_dataset_folder = '/home/chl/PycharmProjects/dataset/189_vime7/test_Satsot/GT/00200'
    ...
    for sub_folder in sub_folder_l:
        ...
        for select_idxs in select_idx_list:
            ...
            for idx, name_idx in enumerate(gt_idx):
                ...
                if save_imgs:                
                    cv2.imwrite(osp.join(save_sub_folder, '{:08d}.png'.format(name_idx)), output)
